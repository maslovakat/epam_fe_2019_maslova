...
// container, slides, buttons, currentSlide
...
//   this.startTouchForSwipe = 0;
//   this.swipeSlider = function (e) {
//     this.startTouchForSwipe - e.changedTouches[0].pageX <= -100 ? moveSlideToLeft() : null;
//     this.startTouchForSwipe - e.changedTouches[0].pageX >= 100 ? moveSlideToRight() : null;
//   }
// }

// let latestPortfolioSlider = new SliderBehaviour();
